...
class _SignalerState extends State<Signaler> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(
          children: [
          ProfilePage1(image: widget.image, nomClient: widget.nomClient, phone: widget.phone, adress: widget.adress,), // Page de profil en arrière-plan
      Container(
    ...
    GestureDetector(
    onTap:() {
    Navigator.pop(context, MaterialPageRoute(builder: (context)=>ProfilePage1(image: widget.image, nomClient: widget.nomClient, phone: widget.phone, adress: widget.adress,)),);  // Revenir à ProfilePage2
    },
    child: Container(
    decoration: BoxDecoration(
