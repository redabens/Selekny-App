    ...
    return Container(
      ...
      child: TextButton(
        onPressed: () async {
          ...
          _demandeClientService.sendDemandeClient(
            widget.datedebut,
            widget.datefin,
            widget.heuredebut,
            widget.heurefin,
          ...
          _demandeArtisanService.deleteDemandeArtisan(
              widget.timestamp, FirebaseAuth.instance.currentUser!.uid);
